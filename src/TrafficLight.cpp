...
{
    _currentTrafficLightPhase = TrafficLightPhase::red;
}
...
{
    return _currentTrafficLightPhase;
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    float cycleTime = 5.0;    // in seconds
    ...
    while (true) 
    {
      ...
      if (elapsedTime.count() > cycleTime) 
      {
        ...
        {
          _currentTrafficLightPhase = TrafficLightPhase::green;
        }
        
        TrafficLightPhase phase = _currentTrafficLightPhase;
